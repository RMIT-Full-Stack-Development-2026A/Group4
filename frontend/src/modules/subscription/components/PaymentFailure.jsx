...
const PaymentFailure = () => {
  return (
    <div className='transition-transform duration-300 hover:scale-105 m-50 p-5 text-center flex flex-col shadow-[0px_4px_9px_0px_rgba(0,0,0,0.1)] gap-5 rounded-lg'>
