...
// Importing icon
import { User, Gamepad2, Crown } from 'lucide-react'
...
const DropDownMenu = () => {
  ...
  return (
    <div className='cursor-pointer p-2 absolute transition-transform duration-300 hover:scale-105 right-9 top-8 shadow-[0px_4px_13px_-3px_rgba(0,_0,_0,_0.1)] '>
